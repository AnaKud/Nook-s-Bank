...
protocol INewsNetworkManager {
    func downloadNews(link: AdditionalLink, newsHandler: @escaping ([NewsResponse]?) -> Void)
}
...
protocol IProphetPricesNetworkManager {
    func downloadTurnip(forTurnipPrices prices: ProphetPrices.Turnip.Request, turnipHandler: @escaping (TurnipResponse) -> Void)
}
